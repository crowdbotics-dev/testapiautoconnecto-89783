...
## Project Structure
    ...
    ├── testapiautoconnecto_89783  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_89783`
...
2. Clone this repo and `cd testapiautoconnecto_89783`
